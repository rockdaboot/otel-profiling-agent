module github.com/elastic/otel-profiling-agent/otel/collector

go 1.22.2

replace github.com/elastic/otel-profiling-agent/otel/receiver => ../receiver

require (
	github.com/elastic/otel-profiling-agent/otel/receiver v0.0.0-00010101000000-000000000000
